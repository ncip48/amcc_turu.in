// ignore_for_file: prefer_const_constructors, provide_deprecation_message
...
class CustomTheme {
  ...
  final Color turuInPrimary, turuInSecondary, turuInTersier;
  ...
  CustomTheme({
    ...
    //turuin
    this.turuInPrimary = const Color(0xff313642),
    this.turuInSecondary = const Color(0xff3E4553),
    this.turuInTersier = const Color(0xffFF7360),
