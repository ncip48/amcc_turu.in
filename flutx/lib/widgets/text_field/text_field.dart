...
class _FxTextFieldState extends State<FxTextField> {
  ...
  void initState() {
    ...
    obscureText = widget.obscureText ??
            widget.textFieldType == FxTextFieldType.password ||
                widget.textFieldType == FxTextFieldType.old_password ||
                widget.textFieldType == FxTextFieldType.new_password
        ? true
        : false;
  }
    ...
    if (labelText == null) {
      switch (widget.textFieldType) {
        ...
        case FxTextFieldType.password:
          ...
          break;
        case FxTextFieldType.old_password:
          maxLines = 1;
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
          ...
          obscureText = obscureText ?? true;
          break;
        case FxTextFieldType.new_password:
          maxLines = 1;
          prefixIcon = prefixIcon ??
              (autoIcon
                  ? Icon(
